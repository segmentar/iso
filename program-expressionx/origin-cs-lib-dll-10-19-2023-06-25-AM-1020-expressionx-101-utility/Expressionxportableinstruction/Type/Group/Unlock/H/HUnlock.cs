...
namespace Core
{
    ...
    {
        public static void HUnlock(Expressionxportable expressionxportable, String value, String lower, String[] array)
        {
            try
            {
                ...
                isEqualCheck = Object.Equals(Expressionxportablename.EntityInstructionUnlock, (String)inflect[0]) is true;
                ...
                Unlock(expressionxportable, format);
