...
namespace Core
{
    ...
    {
        public static void HVTUnlock(Expressionxportable expressionxportable, String value, String lower, String[] array)
        {
            try
            {
                ...
                isEqualCheck = Object.Equals(Expressionxportablename.EntityInstructionVTUnlock, (String)inflect[0]) is true;
                ...
                VTUnlock(expressionxportable, format);
