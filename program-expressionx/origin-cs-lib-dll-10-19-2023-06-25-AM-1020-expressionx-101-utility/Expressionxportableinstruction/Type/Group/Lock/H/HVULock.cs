...
namespace Core
{
    ...
    {
        public static void HVULock(Expressionxportable expressionxportable, String value, String lower, String[] array)
        {
            try
            {
                ...
                isEqualCheck = Object.Equals(Expressionxportablename.EntityInstructionVULock, (String)inflect[0]) is true;
                ...
                VULock(expressionxportable, (String)inflect[4]);
            }
