...
namespace Core
{
    ...
    {
        public static void HULock(Expressionxportable expressionxportable, String value, String lower, String[] array)
        {
            try
            {
                ...
                isEqualCheck = Object.Equals(Expressionxportablename.EntityInstructionULock, (String)inflect[0]) is true;
                ...
                ULock(expressionxportable, (String)inflect[4]);
            }
